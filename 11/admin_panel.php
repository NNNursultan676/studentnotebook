...
if (isset($_POST['add_subject'])) {
    ...
    if (!empty($name)) {
        ...
        if ($stmt->execute([$name, $teacher, $teacher_phone, $max_points])) {
            header('Location: admin_panel.php?success=subject_added');
            exit;
        }
    }
}
...
if (isset($_POST['edit_subject'])) {
    ...
    if (!empty($name) && $subject_id > 0) {
        ...
        if ($stmt->execute([$name, $teacher, $teacher_phone, $max_points, $subject_id])) {
            header('Location: admin_panel.php?success=subject_updated');
            exit;
        }
    }
}
...
if (isset($_POST['delete_subject'])) {
    ...
    if ($stmt->execute([$subject_id])) {
        header('Location: admin_panel.php?success=subject_deleted');
        exit;
    }
}
...
if (isset($_POST['add_task'])) {
    ...
    if (!empty($title) && !empty($due_date)) {
        ...
        if ($stmt->execute([$subject_id, $title, $description, $full_due, $points])) {
            ...
            header('Location: admin_panel.php?success=task_added');
            exit;
        }
    }
}
...
if (isset($_POST['delete_task'])) {
    ...
    if ($stmt->execute([$task_id])) {
        header('Location: admin_panel.php?success=task_deleted');
        exit;
    }
}
...
if (isset($_POST['add_schedule'])) {
    ...
    if (!empty($date) && !empty($time)) {
        ...
        if ($stmt->execute([$date, $subject_id, $time, $room, $teacher])) {
            header('Location: admin_panel.php?success=schedule_added');
            exit;
        }
    }
}
...
if (isset($_POST['delete_schedule'])) {
    ...
    if ($stmt->execute([$schedule_id])) {
        header('Location: admin_panel.php?success=schedule_deleted');
        exit;
    }
}
